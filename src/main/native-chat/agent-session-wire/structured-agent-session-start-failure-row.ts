 ...
 *
 * The session is left reading as one whose last child never finished starting — the state a child
 * that dies after it was published already leaves — so a surface coming into view does not start
 * it again; the next send does.
 */
